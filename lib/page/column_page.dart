...
import 'package:col_row_stack/widget_col/appbar_widget.dart';
import 'package:col_row_stack/widget_col/examples_widget.dart';
import 'package:col_row_stack/widget_col/items/layout_type.dart';
import 'package:col_row_stack/widget_col/items/column_items.dart';
    ...
    switch (index) {
      case 0:
        return Scaffold(
          ...
          body: Container(color: Colors.lightGreen, child: buildContent()),
